...
const state = reactive({
	icon: [
		{ id: 1, name: 'icon-banjishuliang', title: '班级记录归档', desc: '', link: '/subPage/gradefile' },
...
const gotoDetails = (item: {id: number, name: string, title: string, desc: string, link: string}) => {
